 ...
 */
public class MultisAdapter extends RecyclerView.Adapter {
    private List<PopupwindowListItem> mFilterList;
    private OnItemClickLitener mOnItemClickLitener;
    public static HashMap<Integer, Boolean> isSelected;

    public MultisAdapter(List<PopupwindowListItem> datas) {
    ...
    public void setmFilterList(List<PopupwindowListItem> mFilterList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MultisAdapter.MultiViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof MultisAdapter.MultiViewHolder){
            final MultisAdapter.MultiViewHolder viewHolder = (MultisAdapter.MultiViewHolder) holder;
