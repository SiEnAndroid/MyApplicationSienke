...
public class SecurityGridviewImageAdapter extends BaseAdapter {
    ...
    public SecurityGridviewImageAdapter(Context context, ArrayList<String> cropIdLists) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            viewHolder = new SecurityGridviewImageAdapter.ViewHolder();
            convertView = layoutInflater.inflate(R.layout.gridview_image_item, null);
            viewHolder.imageView = (ImageView) convertView.findViewById(R.id.image);
            viewHolder.delete = (ImageView) convertView.findViewById(R.id.delete);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (SecurityGridviewImageAdapter.ViewHolder) convertView.getTag();
        }
