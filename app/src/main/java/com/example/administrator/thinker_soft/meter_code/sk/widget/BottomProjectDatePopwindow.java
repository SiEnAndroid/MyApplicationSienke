 ...
 */
public class BottomProjectDatePopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private ArrayList<ProjectTypeBean> arry;
    ...
    public BottomProjectDatePopwindow(Context context1, String title, ArrayList<ProjectTypeBean> list) {
        super(context1);
        ...
        ids=arry.get(0).getN_PROJECT_TYPE_ID();
        wvList.addScrollingListener(new OnWheelScrollListener() {
            ...
            public void onScrollingFinished(WheelView wheel) {
                ...
                tvName=currentText;
                ids=arry.get(wheel.getCurrentItem()).getN_PROJECT_TYPE_ID();
            }
        });
    }
    ...
    public int setIndex(String name) {
        ...
        for (int i=0;i<arry.size(); i++) {
            Log.e("pgl","=====:"+arry.get(i).getC_PROJECT_TYPE_NAME());
            Log.e("pgl","=====:"+name);
            if (arry.get(i).getC_PROJECT_TYPE_NAME().equals(name)) {
                index=i;
                return index;
            }
        }
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter1 {
        ...
        protected CalendarTextAdapter(Context context, ArrayList<ProjectTypeBean> list, int currentItem, int maxsize, int minsize) {
        ...
        protected CharSequence getItemText(int index) {
            return list.get(index).getC_PROJECT_TYPE_NAME() + "";
        }
    }
