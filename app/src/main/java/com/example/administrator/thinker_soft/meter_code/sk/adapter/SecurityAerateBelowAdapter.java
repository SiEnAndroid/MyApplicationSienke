...
public class SecurityAerateBelowAdapter extends RecyclerArrayAdapter<AetateBean.ListBean> {

    public SecurityAerateBelowAdapter(Context context) {
        super(context);
    ...
    public class SecurityAerateViewHolder extends BaseViewHolder<AetateBean.ListBean> {
        ...
        public SecurityAerateViewHolder(ViewGroup parent) {
            super(parent, R.layout.item_aerate_below);
