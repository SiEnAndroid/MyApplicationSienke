...
/**
 * 方根抄表主页
 * SecurityChooseRootFragment class
 * @author g
 * @date 2018/8/21:16:52]
 */
public class SecurityChooseRootFragment  extends Fragment{
        private View view;
        ...
        view = inflater.inflate(R.layout.fragment_root_security, null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {           //listview点击事件
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                sharedPreferences.edit().putString("currentEndTime",item.getEndTime()).apply();
                Log.e("结束时间",item.getEndTime());
            }
        });
