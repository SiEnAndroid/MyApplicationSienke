 ...
 */
public class BottomDatePopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private ArrayList<ReportTranCdBean> arry;
    ...
    public BottomDatePopwindow( Context context1,String title,ArrayList<ReportTranCdBean> list) {
        super(context1);
        ...
        wvList.addScrollingListener(new OnWheelScrollListener() {
            ...
            public void onScrollingFinished(WheelView wheel) {
                ...
                tvName=currentText;
                ids=arry.get(wheel.getCurrentItem()).getId();
            }
        });
    ...
    public int setIndex(String name) {
        ...
        for (int i=0;i<arry.size(); i++) {
            if (arry.get(i).getName().equals(name)) {
                index=i;
                return index;
            }
        }
    ...
    private class CalendarTextAdapter extends AbstractWheelTextAdapter1 {
        ArrayList<ReportTranCdBean> list;

        protected CalendarTextAdapter(Context context, ArrayList<ReportTranCdBean> list, int currentItem, int maxsize, int minsize) {
